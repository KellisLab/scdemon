...
def robust_se_default(U, V, *, B=None, t_cutoff:float=None, abs_t:bool=False, min_cor:float=0., nominal_p_cutoff:float=0.05, n_components:int=None, min_norm:float=1e-5) -> sparse.csc_matrix:
    """
    U: U from SVD
    V: V\Sigma from SVD
